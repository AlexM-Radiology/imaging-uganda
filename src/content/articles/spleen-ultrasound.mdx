...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', margin: '24px 0' }}>
	<div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={img1} alt="Normal Spleen" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Normal spleen with homogeneous, fine and uniform granular pattern and a thin, hyperechoic capsule surrounding the organ</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={img2} alt="Biliary Hamartoma" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Normal splenic vein and the anatomical relations of the spleen</span>
  </div>
</div>
...
5. Sicke cell disease: Sickle cell disease almost always affects the spleen. The most common splenic complications are autosplenectomy, acute sequestration, hypersplenism, massive infarction, and abscess.
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', margin: '24px 0' }}>
	<div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={splenomegaly} alt="Normal Spleen" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Splenomegaly with compression of the left kidney</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={spleniccyst} alt="Splenic cyst" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Central 5-cm cyst with irregular borders and a simple 6-cm cyst at the inferior portion of the spleen. Both congenital cysts and pseudocysts may have this appearance.</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={hemangioma} alt="Biliary Hamartoma" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Hemangioma. Well-deined, rounded, echogenic lesion (arrow) is similar to the typical liver hemangiomas.</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={splenicinfact} alt="splenic infact" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Coronal image shows a well-deined hypoechoic central area reaching the splenic capsule medial and lateral in a patient with sickle cell disease, in keeping with splenic infarct</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={gaucherdisease} alt="spleen gaucher disease" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>Gaucher disease with
Enlarged spleen containing a 2-cm heterogeneous nodule</span>
  </div>

  <div style={{ display: 'flex', flexDirection: 'column', width: '23%', minWidth: '150px' }}>
    <Image src={gamnagandybodies} alt="gamna gandy bodies" style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: '4px' }} />
    <span style={{ fontSize: '0.8rem', color: '#555', marginTop: '6px' }}>The spleen shows multiple tiny echogenic foci without acoustic shadowing diffusely involving the parenchyma. These are siderotic nodules or Gamna-Gandy nodules</span>
  </div>
</div>
